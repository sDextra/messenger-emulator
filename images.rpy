...
init python:
    # HUD
    def dn_hud(st, at):
        return color_theme('messenger/hud.png'), 0.1
    # BACK
    def dn_back(st, at):
        return color_theme('messenger/back.png'), 0.1
    # BOXES
    def dn_box(st, at):
        return color_theme('messenger/box.png'), 0.1
    def dn_box_hv(st, at):
        return color_theme(color_brightness('messenger/box.png')), 0.1
    def dn_box_two(st, at):
        return color_theme('messenger/box_two.png'), 0.1
    def dn_box_two_hv(st, at):
        return color_theme(color_brightness('messenger/box_two.png')), 0.1
    # BUTTONS
    def dn_arr(st,at):
        return color_theme('messenger/arrow.png'), 0.1
    def dn_arr_hv(st,at):
        return color_theme(color_brightness('messenger/arrow.png')), 0.1
    def dn_oth(st,at):
        return color_theme('messenger/other.png'), 0.1
    def dn_oth_hv(st,at):
        return color_theme(color_brightness('messenger/other.png')), 0.1
    def dn_mgn(st,at):
        return color_theme('messenger/magnifier.png'), 0.1
    def dn_mgn_hv(st,at):
        return color_theme(color_brightness('messenger/magnifier.png')), 0.1
    # AUDIO
    def dn_pl(st,at):
        return color_theme('messenger/audio/play.png'), 0.1
    def dn_pl_hv(st,at):
        return color_theme(color_brightness('messenger/audio/play.png')), 0.1
    def dn_st(st,at):
        return color_theme('messenger/audio/stop.png'), 0.1
    def dn_st_hv(st,at):
        return color_theme(color_brightness('messenger/audio/stop.png')), 0.1
